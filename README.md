...
- **Resolusi Preprocessing**: 224×224 piksel (standar input MobileNetV2)
- **Color Space**: RGB (3 channel)
- **Ukuran File**: 50-500 KB per citra
- **Variasi Kondisi**: Pencahayaan (terang/sedang/redup), background (uniform/kompleks), sudut pengambilan (frontal/miring), tingkat infeksi (ringan/sedang/berat)
...
**a. Download Dataset**
Dataset publik diunduh dari platform RoboFlow Universe menggunakan API key yang disediakan. Format download adalah ZIP file yang berisi folder terpisah untuk setiap kelas penyakit.

**b. Verifikasi Data**
Seluruh citra diverifikasi untuk memastikan:
- Tidak ada file corrupt atau rusak
- Label sesuai dengan kondisi visual daun
- Tidak ada duplikasi data
- Kualitas citra memadai (tidak blur berlebihan)

**c. Organisasi Data**
Data diorganisir dalam struktur folder yang sistematis sesuai dengan kelas dan split dataset (train/val/test) untuk memudahkan proses loading dan preprocessing.
